...
##Calculating the probably with a hypergeometric test
...
| GO:0006468      | 210 | 8 |
   ...
   \* 26005 GO terms were annotated on the predicted genes in this genome)  
...
mydata_reordered <- mydata[,c(1,4,5,2,3)]
...
write.table(mydata_reordered,file=filepath_output,sep = "\t",eol = "\n", na = "NA", dec = ",", quote=FALSE,row.names = FALSE,col.names = TRUE)
```
